...
-- alter table subgenre rename column id_genre to id_subgenre;
-- alter table subgenre rename column "group" to genre;
...
insert into tags values(1, 'funny', 1, 0, now(), 1501986, 3);
insert into tags values(2, 'sad', 1, 0, now(), 1501986, 2);
insert into tags values(3, 'funny', 0, 1, now(), 1501986, 1);
